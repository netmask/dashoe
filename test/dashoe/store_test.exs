defmodule Dashoe.StoreTest do
  ...
  describe "product_inventory_locations" do
    ...
    test "get_product_inventory_location!/1 returns the product_inventory_location with given id" do
      ...
      assert Store.get_product_inventory_location!(product_inventory_location.id) ==
    ...
    test "create_product_inventory_location/1 with valid data creates a product_inventory_location" do
      ...
      assert {:ok, %ProductInventoryLocation{} = product_inventory_location} =
               Store.create_product_inventory_location(valid_attrs)
    ...
    test "update_product_inventory_location/2 with valid data updates the product_inventory_location" do
      ...
      update_attrs = %{
        ...
        product_code: "some updated product_code",
        stats: %{}
      }

      assert {:ok, %ProductInventoryLocation{} = product_inventory_location} =
               Store.update_product_inventory_location(product_inventory_location, update_attrs)
    ...
    test "update_product_inventory_location/2 with invalid data returns error changeset" do
      ...
      assert {:error, %Ecto.Changeset{}} =
               Store.update_product_inventory_location(product_inventory_location, @invalid_attrs)

      assert product_inventory_location ==
               Store.get_product_inventory_location!(product_inventory_location.id)
    end

    test "delete_product_inventory_location/1 deletes the product_inventory_location" do
      product_inventory_location = product_inventory_location_fixture()

      assert {:ok, %ProductInventoryLocation{}} =
               Store.delete_product_inventory_location(product_inventory_location)
    ...
    test "change_product_inventory_location/1 returns a product_inventory_location changeset" do
      ...
      assert %Ecto.Changeset{} =
               Store.change_product_inventory_location(product_inventory_location)
    end
  end
end
